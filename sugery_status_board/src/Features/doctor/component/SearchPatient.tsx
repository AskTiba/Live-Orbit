      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 justify-center">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 text-sm font-medium bg-accentMain text-white rounded-lg hover:bg-accentSub transition cursor-pointer"
          >
            Look Up
          </button>
          <button
            onClick={handleClear}
            className="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 transition cursor-pointer"
          >
            Clear
          </button>
        </div>
